...
function callRef(cxt, v, sch, $async) {
    ...
    function callSyncRef() {
        ...
        gen.code((0, codegen_1._) `const ${visitedNodes} = visitedNodesForRef.get(${v}) || new Set()`);
        gen.if((0, codegen_1._) `!${visitedNodes}.has(${cxt.data})`, () => {
            gen.code((0, codegen_1._) `visitedNodesForRef.set(${v}, ${visitedNodes})`);
            gen.code((0, codegen_1._) `const dataNode = ${cxt.data}`);
            gen.code((0, codegen_1._) `${visitedNodes}.add(dataNode)`);
