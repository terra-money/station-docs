...
- The latest version of the [Station Chrome extension](../get-started.mdx) (Station Wallet 7.4.2 and above)
...
You can also create and send transactions to the Terra network while using Wallet Kit. You can use [Feather.js](https://docs.terra.money/develop/feather-js/getting-started/) to generate a sample transaction:
